  ...
  return (
    <section className='w-full md:py-28 py-8'
      ...
      <main className=' mx-auto max-w-[80rem] flex flex-col md:flex-row gap-5  px-4 py-[30px]'>
        ...
        {/*  div */}
       <div className='w-1/2'>
        <img src="/public/image4.png" alt="arror" />
       </div>
...
<h3 className='text-[#873EFC] text-[20px] font-[700] uppercase '>Ride it</h3>
  ...
  <p className='text-[#625D7E]  text-[18px] tracking-[-0.2] font-plus-jakarta-sans  font-medium'>Glide into glamorous events, catch your flight with a breeze, or explore hidden city gems. TaxiDaniel is your 24/7 companion for stylish rides, expert drivers, and clean, comfortable cars. 
We handle the traffic, you enjoy the journey. </p>
  {/* buttons */}
