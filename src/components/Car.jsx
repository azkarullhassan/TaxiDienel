...
const Car = () => {
  return (
    <section className='w-full md:py-28 py-8 bg-gray-100 mb-52 md:mb-52'>

      <main className='h-screen md:h-[100vh] rounded-2xl mx-auto max-w-[80rem] flex flex-col md:flex-row gap-5 px-4 py-[30px]'
        style={{
      ...
      >
        <div className='flex flex-col md:items-start items-center pl-7 md:gap-6 gap-8 md:w-1/2 w-full text-center md:text-start'>
          ...
          <div className='flex flex-col md:flex-row space-y-5 md:space-x-36 md:space-y-0'>
          ...
          <div className='flex flex-col md:flex-row space-y-5 md:space-x-20 md:space-y-0'>
            <div className='text-white'>
